...
export default function AuthScreen({ navigation, onClose }: { navigation?: any, onClose?: () => void }) {
    ...
    return (
        <View style={styles.authContainer}>
            ...
            <View style={[styles.blob, { top: -100, left: -50, backgroundColor: theme.colors.primary }]} />
            ...
            >
                ...
                <View style={styles.authFormCard}>
                    <View style={styles.inputGroup}>
                        <Ionicons name="person-outline" size={20} color={theme.colors.placeholder} style={styles.inputIcon} />
                        <TextInput 
                            value={user} 
                    ...
                    {!isLoginMode && (
                        <View style={styles.inputGroup}>
                            <Ionicons name="mail-outline" size={20} color={theme.colors.placeholder} style={styles.inputIcon} />
                            <TextInput 
                                value={email} 
                    ...
                    <View style={styles.inputGroup}>
                        <Ionicons name="lock-closed-outline" size={20} color={theme.colors.placeholder} style={styles.inputIcon} />
                        <TextInput 
                            value={pass} 
                    ...
                    {!isLoginMode && (
                        <View style={styles.inputGroup}>
                            <Ionicons name="shield-checkmark-outline" size={20} color={theme.colors.placeholder} style={styles.inputIcon} />
                            <TextInput 
                                value={confirmPass} 
                ...
                <TouchableOpacity onPress={() => setIsLoginMode(!isLoginMode)} style={{ alignSelf: "center", marginTop: 30 }}>
                    <Text style={styles.switchAuthText}>
                        ...
                        <Text style={{ color: theme.colors.primary, fontWeight: "bold" }}>{isLoginMode ? "Create Account" : "Sign In"}</Text>
                    </Text>
                </TouchableOpacity>
            </ScrollView>
